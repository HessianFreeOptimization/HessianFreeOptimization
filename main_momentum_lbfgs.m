...
for trial = 1:trials
    ...
    eval_g = 0;
    params.trial = trial;
    [llrecord, errrecord, weights, eval_fs, eval_gs] = fixstep_momentum_lbfgs(true,iters, params);
...
save(sprintf('./saved/momentum-lbfgs-for-%d_iters-%d_trials.mat', iters, trials), 'records');
