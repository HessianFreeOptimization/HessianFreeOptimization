...
def train():
	...
	with tf.name_scope('train'):
		...
		# [Yifeng] https://github.com/tensorflow/tensorflow/blob/master/tensorflow/contrib/opt/python/training/external_optimizer.py
		...
		optimizer = ScipyOptimizerInterface(cross_entropy, method='SLSQP')
		...
		# optimizer_def = tf.train.L_BFGS_Optimizer(learning_rate=FLAGS.learning_rate)
