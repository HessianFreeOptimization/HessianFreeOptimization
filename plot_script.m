...
iters = [base_iters, base_iters, base_iters, base_iters, ...
    ...
    base_iters, base_iters, base_iters];
max1 = 0;
min1 = Inf;
algorithms_plot = {};
...
for index = 1 : length(selected)
    ...
    if exist(file_name, 'file') == 2
        load(file_name);
        [max1, min1, plots1, plots2] = plot_curve(false, records, fig1, fig2, max1, min1, plots1, plots2, colors(al_iter, :), lines{al_iter}, labelx_ind);
        hold on;
